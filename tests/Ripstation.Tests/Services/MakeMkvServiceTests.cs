...
public class MakeMkvServiceTests
{
        ...
        string[]? existingFiles = null)
    {
        ...
        return new MakeMkvService(runner, fs);
    }
    ...
    public async Task ScanDisk_ParsesCInfoType()
    {
        ...
        var (disk, _) = await svc.ScanDiskAsync("0", "makemkvcon64.exe", null, _ => { }, default);
    ...
    public async Task ScanDisk_ParsesCInfoName()
    {
        ...
        var (disk, _) = await svc.ScanDiskAsync("0", "exe", null, _ => { }, default);
    ...
    {
        var svc = Build([]);
        var (disk, _) = await svc.ScanDiskAsync("1", "exe", null, _ => { }, default);
    ...
    public async Task ScanDisk_ParsesTitleName()
    {
        ...
        var (_, titles) = await svc.ScanDiskAsync("0", "exe", null, _ => { }, default);
    ...
    public async Task ScanDisk_ReportsPrgvProgressAsPercentage()
    {
        ...
        await svc.ScanDiskAsync("0", "exe", progress, _ => { }, default);
    ...
    public async Task ScanDisk_MsgWithErrorFlag_PrefixesLog()
    {
        ...
        await svc.ScanDiskAsync("0", "exe", null, logged.Add, default);
    ...
    public async Task ScanDisk_NonZeroExitCode_Throws()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(
            () => svc.ScanDiskAsync("0", "exe", null, _ => { }, default));
    }
    ...
    public async Task ScanDisk_CancelledResult_ThrowsOperationCancelled()
    {
        ...
        var svc = new MakeMkvService(runner, new FakeFileSystem());

        await Assert.ThrowsAnyAsync<OperationCanceledException>(
            () => svc.ScanDiskAsync("0", "exe", null, _ => { }, cts.Token));
    }
    ...
    public async Task RipTitle_ReturnsMkvPathFromTinfo27()
    {
        ...
        var result = await svc.RipTitleAsync("0", "0", @"C:\tmp", "exe", null, _ => { }, default);
    ...
    public async Task RipTitle_NoTinfo27_ThrowsInvalidOperation()
    {
        var svc = Build([]);
        await Assert.ThrowsAsync<InvalidOperationException>(
            () => svc.RipTitleAsync("0", "0", @"C:\tmp", "exe", null, _ => { }, default));
    }
    ...
    public async Task RipTitle_CancelledResult_ThrowsOperationCancelled()
    {
        ...
        await Assert.ThrowsAnyAsync<OperationCanceledException>(
            () => svc.RipTitleAsync("0", "0", @"C:\tmp", "exe", null, _ => { }, cts.Token));
    }
}
